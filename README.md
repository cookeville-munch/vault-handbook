...
- [New Contributor Onboarding](CONTRIBUTING-ONBOARDING.md)
- [Module Structure Documentation](docs/structure.md)
- [Validation Process](docs/validation/validation_process_visual.md)
...
This repository uses automated validation pipelines:
